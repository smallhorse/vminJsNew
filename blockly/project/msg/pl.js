...
/**Sensor Category */
  ...
  servo_status_popup_tips:"Nie można wyregulować odpowiadającego siłownika w przypadku robota w trybie zablokowanym",
    ...
    lights_tips:"Obecny model nie jest połączony z żadnym świetle",
  ...
  //以下内容需要新增翻译
  movements:"movements",
  posture_set_desc : "Otwórz odpowiedni przełącznik i ustawić działanie robota",
  posture_ok_desc : "Pose Po wprowadzeniu nazwy pozycji",
  /*项目  begin*/
  //保存项目
  input_rule_msg : "Nie można wprowadzić specjalnych znaków. Maksymalna dozwolona liczba znaków: %1 (zwykłe) lub %2 (chińskie).",
  variable_inputrule_msg : "Nie może rozpoczynać się od cyfry. Nie można wprowadzić specjalnych znaków. Maksymalna dozwolona liczba znaków: %1 (zwykłe) lub %2 (chińskie).",
  recording_name_popup_msg : "Nazwa Zapis zawiera niedozwolone znaki",
  /*设置音效弹出框音效文件国际化  end*/
  infrared_tips:"czujnik podczerwieni nie jest połączony z obecnym modelu",
  touch_tips:"Czujnik dotykowy nie jest połączony z obecnym modelu",
  gyroscope_tips:"Czujnik żyroskopowy nie jest połączony z obecnym modelu",
  id_infinite_loop_error:'Wyjście programu ze względu na brak pamięci, proszę wrócić i ponownie',
  // 新手指引
