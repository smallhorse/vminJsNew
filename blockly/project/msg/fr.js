var MSG = {
  ...
  /*运动  end*/
    posture_set_desc : "Ouvrez le commutateur droit et réglez l'action du robot",
  ...
  /* need to be removed, wait to confirm */
   ...
   /*项目  begin*/
    //保存项目
    input_rule_msg : "Les caractères spéciaux ne sont pas pris en charge. Un maximum de %1 caractères latins ou %2 caractères chinois peut être saisi.",
    variable_inputrule_msg : "Impossible de commencer par un chiffre. Les caractères spéciaux ne sont pas pris en charge. Un maximum de %1 caractères latins ou %2 caractères chinois peut être saisi.",
  ...
  /*设置音效弹出框音效文件国际化  begin*/
    ...
    recording_name_popup_msg : "Le nom d'enregistrement contient des caractères non valides",
    animal:"animal",
    machine:"machine",
  ...
  /*设置音效弹出框音效文件国际化  end*/
    ...
    lights_tips:"Le modèle actuel n'est pas connecté à aucune lumière",
    ...
    infrared_tips:"Le capteur infrarouge n'est pas connecté au modèle actuel",
    touch_tips:"Le capteur tactile n'est pas connecté au modèle actuel",
    gyroscope_tips:"Le capteur gyroscopique n'est pas connecté au modèle actuel",


    id_infinite_loop_error:'Programme de sortie en raison de la mémoire insuffisante, veuillez revenir en arrière et réessayer',
    // 新手指引
